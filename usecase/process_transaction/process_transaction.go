...
import (
	...
	"github.com/ricardo-ltm/fullcycle5-microservice/adapter/broker"
...
func (p *ProcessTransaction) rejectedTransaction(transaction *entity.Transaction, invalidTransaction error) (TransactionDtoOutput, error) {
	log.Println("rejectedTransaction: passou aqui", transaction)
...
func (p *ProcessTransaction) Execute(input TransactionDtoInput) (TransactionDtoOutput, error) {
	...
	if invalidCC != nil {
		return p.rejectedTransaction(transaction, invalidCC)
	}
